# Copilot Instructions for NanoBananaCli
...
2. **Compare parameters** — CLI command parameters in `nanobanana_cli/commands/` should match the corresponding OpenAPI endpoint's request body schema.
...
4. **Update client** — If API endpoints change, update `nanobanana_cli/core/client.py` accordingly.
