...
def test_settings_default_values():
    ...
    assert settings.default_model == "nano-banana"


def test_settings_from_environment():
    os.environ["ACEDATACLOUD_API_TOKEN"] = "test-token-123"
    os.environ["ACEDATACLOUD_API_BASE_URL"] = "https://custom.api.example.com"
    os.environ["NANOBANANA_REQUEST_TIMEOUT"] = "300"
    os.environ["NANOBANANA_DEFAULT_MODEL"] = "nano-banana-pro"
    ...
    try:
        ...
        assert settings.default_model == "nano-banana-pro"
    finally:
        del os.environ["ACEDATACLOUD_API_TOKEN"]
        del os.environ["ACEDATACLOUD_API_BASE_URL"]
        del os.environ["NANOBANANA_REQUEST_TIMEOUT"]
        del os.environ["NANOBANANA_DEFAULT_MODEL"]
